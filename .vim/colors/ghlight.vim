...
let theme.fg_widget             = '#BABBBD'
let theme.fg_conceal            = '#e2e8eb'
let theme.fg_overlay            = '#2f363d'
...
for key in keys(s:text_colors)
  ...
  call s:_('Underline' . key, s:text_colors[key], '', 'undercurl')
endfor
...
call s:_('Visual',         '', theme.bg_selection, 'bold')
...
hi! link DiagnosticHint ModeMsg
...
" blue
highlight! CmpItemAbbrMatch guibg=NONE guifg=#0066BF gui=bold
highlight! CmpItemAbbrMatchFuzzy guibg=NONE guifg=#0066BF gui=bold

" light blue
highlight! CmpItemKindVariable guibg=NONE guifg=#007ACC gui=bold
highlight! CmpItemKindInterface guibg=NONE guifg=#007ACC gui=bold
highlight! CmpItemKindEnum guibg=NONE guifg=#007ACC gui=bold
" pink
highlight! CmpItemKindFunction guifg=#6F42C1 gui=bold
highlight! CmpItemKindMethod guifg=#6F42C1 gui=bold
" front
highlight! CmpItemKindText guibg=NONE guifg=#444D56 gui=bold
highlight! CmpItemKindProperty guibg=NONE guifg=#444D56 gui=bold
highlight! CmpItemKindUnit guibg=NONE guifg=#444D56 gui=bold
" yellow
