...
aichat "Please suggest $MESSAGE_COUNT commit messages, given the following diff:
\`\`\`diff
$(git diff --cached)
\`\`\`
...
WrWrite your $MESSAGE_COUNT commit messages below in the format shown in Output Template section above."
